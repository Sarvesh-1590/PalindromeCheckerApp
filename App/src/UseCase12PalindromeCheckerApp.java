...
public class UseCase12PalindromeCheckerApp {
    ...
    public static void testCase12() {
        ...
        PalindromeStrategyUC12 stackStrategy = new StackStrategyUC12();
        executeStrategy(stackStrategy, input);

        // 2. Using Deque Strategy
        PalindromeStrategyUC12 dequeStrategy = new DequeStrategyUC12();
     ...
     */
    private static void executeStrategy(PalindromeStrategyUC12 strategy, String input) {
 ...
 */
interface PalindromeStrategyUC12 {
    /**
 ...
 */
class StackStrategyUC12 implements PalindromeStrategyUC12 {
    @Override
 ...
 */
class DequeStrategyUC12 implements PalindromeStrategyUC12 {
    @Override
    public boolean isValid(String input) {
        if (input == null)
            return false;
